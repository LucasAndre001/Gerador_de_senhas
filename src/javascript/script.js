...
function getPasswordSize(){
    ...
    if (isNaN(size) || size < 4 || size > 128) {
        ...
        message('Tamanho inválido, digite um número entre 4 e 128!', '#b92727ff');
    }
...
document.querySelector('#generate').addEventListener('click', function(){
    ...
    if (!charTypes.length) {
        message('Selecione pelo menos um tipo de caractere!', '#b92727ff')
        return;
    }
...
document.querySelector('#copy').addEventListener('click', function(){
    ...
    message('Senha copiada com sucesso!', '#33b927ff');
});
